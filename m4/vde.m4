...
dnl  VDE_CHECK_LIB_HEADER(library, function, header,
...
AC_DEFUN([VDE_CHECK_LIB_HEADER], [
  vde_check_lib_headers_save_LIBS=$LIBS
  LIBS="-l$1 $LIBS"
...
char $2 ();], [$2])],
  ...
  LIBS=$vde_check_lib_headers_save_LIBS
